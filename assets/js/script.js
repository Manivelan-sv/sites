...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Manivelan";
            $("#favicon").attr("href", "assets/images/favicon.JPG");
        }
        else {
            document.title = "S.V.Manivelan";
...
var typed = new Typed(".typing-text", {
    strings: ["Theoretical Physics", "Chaos", "Nonlinear Dynamics", "Extreme Value Theory"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
var typed = new Typed(".typing-text1", {
    strings: ["Manivelan😊","மணிவேலன்" ,"S.V.Manivelan", "Manivelan😎"],
    loop: true,
    typeSpeed: 30,
    backSpeed: 25,
    backDelay: 500,
